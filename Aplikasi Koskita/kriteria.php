        ...
        <div class="row">
            ...
            <div class="col">
                <div class="" style="margin-top: -650px;">
                    <h1 style="margin-left: 260px; padding-bottom: 10px; color: #044750;">
                        Kriteria
                    </h1>
                    ...
                    <div class="col-lg-offset-3 panel panel-default" style="margin-right: 50px;">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                                <a href="addkriteria.php" data-toggle="tab">Tambah Kriteria</a>
                            </li>
                        </ul>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a
                                                        href="editkriteria.php?id_kriteria=<?php echo $row['id_kriteria'] ?>">
                                                        <i class="fa fa-edit fa-fw"></i>
                                                </td>
                                                <td align="center">
                                                    <a
                                                        href="hapuskriteria.php?id_kriteria=<?php echo $row['id_kriteria'] ?>">
